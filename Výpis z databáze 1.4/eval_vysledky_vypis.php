...
if (isset($_POST["datum"]))$datum_post = $_POST["datum"];
...
if(isset($datum_post))
{
    $filtr = $filtr . ",h.datum = '" . $datum_post . "'";
}
if(isset($predmet_post))
{
    $filtr = $filtr . ",p.nazev = '" . $predmet_post . "'";
}
if(isset($tridy_post))
{
    $filtr = $filtr . ",t.trida = '" . $tridy_post . "'";
}
if(isset($skupina_post))
{
    if($filtr != "")
    {
        $filtr = $filtr . ",h.skupina = '" . $skupina_post . "'";
    }
}
